...
createListeners:function(){
	...
	this.start.addEventListener("click",function(){
		...
		document.getElementById("okBtnStart").style.display = "none";
		t.displayDate();
	}),
	this.end.addEventListener("click",function(){
		...
		t.capCalculating();
		document.getElementById("v-cal").style.display = "none";
		document.getElementById("okBtnEnd").style.display = "none";
		t.displayDate();
	})
},
...
dateClicked:function(){
	...
	for(var e=0;e<this.activeDates.length;e++)
		this.activeDates[e].addEventListener("click",function(e){
			...
			if (previousSelection != null) {previousSelection.removeAttribute("data-calendar-selected");}
			previousSelection = this,this.setAttribute("data-calendar-selected","true"),t.showOkBtn()
		})
},
...
showOkBtn:function(){
	if (okBtnSelection == 'start'){
		document.getElementById("okBtnStart").style.display = "block";
	}
	if (okBtnSelection == 'end'){
		document.getElementById("okBtnEnd").style.display = "block";
	}
},
displayDate:function(){
	if (okBtnSelection == 'start'){
		var startDateSplitString = startDate.split(" ");
		document.getElementById("startDate").value = startDateSplitString[2] + "." + startDateSplitString[1] + "." +  startDateSplitString[3];
	}
	if (okBtnSelection == 'end'){
		var endDateSplitString = endDate.split(" ");
		document.getElementById("endDate").value = endDateSplitString[2] + "." + endDateSplitString[1] + "." +  endDateSplitString[3];
	}
},
capCalculating:function(){
	if (startDate != undefined && endDate != undefined){
		...
		document.getElementById("freeDays").innerHTML = ", vabu päevi: " + offDays;
		document.getElementById("offDays").innerHTML = ", tööpäevi: " + (cap-offDays);
	}
},
};